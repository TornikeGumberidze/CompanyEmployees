...
namespace Service
{
    internal sealed class EmployeeService : IEmployeeService
    {
        ...
        public async Task<(IEnumerable<EmployeeDto> employeeDtos,MetaData metaData)> GetEmployeesForCompanyAsync(Guid companyId,EmployeeParameters employeeParameters, bool trackChanges)
        {
            ...
            var employeesWithMetaData = await _repository.Employee.GetEmployeesForCompanyAsync(companyId,employeeParameters, trackChanges);
